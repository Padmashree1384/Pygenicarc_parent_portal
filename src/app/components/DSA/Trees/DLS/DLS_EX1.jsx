...
const DLS_EX1 = () => {
  ...
  const setupTree = () => {
    ...
    const H = new Node('H', 100, 300);
    const I = new Node('I', 200, 300);
    const J = new Node('J', 280, 300);
    const K = new Node('K', 380, 300);
    const L = new Node('L', 450, 300);
    const M = new Node('M', 550, 300);
